...
const STYLIST: Stylist = {
  ...
  specialties: ['Color', 'Balayage', 'Curly Hair', 'Highlights', 'Hair Extensions', 'Bridal Styling'],
  services: [
    { id: '101', name: 'Haircut & Style', description: 'Precision cut with consultation and styling', duration: 60, price: 85, stylist_id: '1' },
    { id: '102', name: 'Color', description: 'Full color treatment with premium products', duration: 120, price: 130, stylist_id: '1' },
    { id: '103', name: 'Balayage', description: 'Custom balayage for natural-looking, dimensional color', duration: 180, price: 200, stylist_id: '1' },
    { id: '104', name: 'Highlights', description: 'Full or partial highlights for added dimension', duration: 150, price: 175, stylist_id: '1' },
    { id: '105', name: 'Keratin Treatment', description: 'Smoothing treatment to reduce frizz', duration: 180, price: 250, stylist_id: '1' },
    { id: '106', name: 'Bridal Hair', description: 'Special occasion styling with consultation', duration: 90, price: 120, stylist_id: '1' },
  ],
...
const REVIEWS: Review[] = [
  {
    ...
    stylist_id: '1',
    rating: 5,
    comment: 'Jessica is amazing! She gave me the best haircut I\'ve ever had and took the time to understand exactly what I wanted.',
  ...
  },
  {
    ...
    stylist_id: '1',
    rating: 5,
    comment: 'I loved my balayage! Jessica is a true artist and really knows how to work with different hair types. Will definitely be coming back!',
  ...
  },
  {
    ...
    stylist_id: '1',
    rating: 4,
    comment: 'Great experience overall. Jessica is very knowledgeable and helped me find a style that works for my face shape and lifestyle.',
          ...
          <div className="rounded-lg border bg-white p-4 shadow-sm">
            ...
            <div className="mb-4 space-y-3 text-sm text-gray-600">
              <p className="flex items-center gap-2">
                ...
                <Link href={`/salons/${SALON.id}`} className="hover:text-blue-500 hover:underline">
                  {SALON.name}
                </Link>
              </p>
            </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-2">
              {stylist.specialties.map((specialty) => (
                <span key={specialty} className="rounded-full bg-blue-100 px-3 py-1 text-sm text-blue-800">
                  {specialty}
                </span>
              ))}
            </div>
              ...
              {stylist.services.map((service, index) => (
                ...
                >
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">{service.duration} minutes</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <span className="text-lg font-semibold">${service.price}</span>
                    <Button size="sm" variant="outline" asChild>
                      <Link href={`/book?stylist=${stylist.id}&service=${service.id}`}>
          ...
          <div className="mb-8">
            <div className="mb-4 flex items-center justify-between">
              ...
              <Button variant="outline" size="sm" asChild>
                <Link href={`/reviews/new?stylist=${stylist.id}`}>Write a Review</Link>
              </Button>
            </div>
            ...
            <div className="space-y-4">
              {reviews.map((review) => (
                <div key={review.id} className="rounded-lg border bg-white p-4 shadow-sm">
                  ...
                  {(review.skill_rating || review.timeliness_rating || review.value_rating) && (
